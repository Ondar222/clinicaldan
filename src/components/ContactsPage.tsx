              ...
              <div className="bg-white rounded-lg shadow-md p-6 flex flex-col h-full">
                ...
                <div className="space-y-6 flex-grow">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">Пн-Пт: {CLINIC_CONFIG.workingHours.weekdays}</p>
                    <p className="text-gray-600 leading-relaxed">Сб: {CLINIC_CONFIG.workingHours.saturday}</p>
                    <p className="text-gray-600 leading-relaxed">Вс: {CLINIC_CONFIG.workingHours.sunday}</p>
                  </div>
                </div>
              </div>
