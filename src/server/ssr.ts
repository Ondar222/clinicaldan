...
const SEO_PAGES: Record<string, {
  ...
  '/about': {
    title: 'О клинике Алдан — многопрофильный медицинский центр в Алдане',
    description: 'Клиника Алдан с 2013 года оказывает медицинскую помощь в Алдане. Более 25 направлений, современное оборудование, высококвалифицированные специалисты. Запись на прием по телефону.',
    ogType: 'website',
    canonical: '/about'
  },
  '/contacts': {
  ...
  '/doctors': {
    title: 'Врачи клиники Алдан — высококвалифицированные специалисты в Алдане',
  ...
  '/directions': {
    title: 'Медицинские направления клиники Алдан в Алдане',
  ...
  '/reviews': {
    ...
    description: 'Отзывы пациентов о клинике Алдан. Реальные отзывы о качестве медицинских услуг, работе врачей и обслуживании в нашей клинике в Алдане.',
    ogType: 'website',
    canonical: '/reviews'
  },
  '/checkups': {
    title: 'Медосмотры и профилактические обследования — Клиника Алдан',
    description: 'Профилактические медицинские осмотры, диспансеризация, предрейсовые и периодические медосмотры. Полное обследование организма в Алдане.',
    ogType: 'website',
    canonical: '/checkups'
  },
  '/news': {
  ...
  '/tools': {
    ...
    description: 'Современное медицинское оборудование клиники Алдан в Алдане. Диагностические аппараты экспертного класса для точной диагностики и эффективного лечения.',
    ogType: 'website',
    canonical: '/tools'
  },
  '/stock': {
  ...
  '/medical-examinations': {
    ...
    description: 'Все виды медицинских осмотров: предварительные, периодические, профилактические. Оформление справок и медицинских книжек в Алдане.',
    ogType: 'website',
    canonical: '/medical-examinations'
  },
  '/services': {
    title: 'Медицинские услуги клиники Алдан в Алдане',
...
DIRECTIONS.forEach(direction => {
  ...
  SEO_PAGES[url] = {
    title: direction.seoTitle || `${direction.title} в Алдане — Клиника Алдан`,
 ...
 */
export function generateSeoHtml(pathname: string, template: string): string {
