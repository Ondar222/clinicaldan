...
export const CLINIC_CONFIG: ClinicContact & SeoConfig = {
  ...
  defaultDescription: 'Клиника Алдан в Кызыле с 2013 года. Более 25 медицинских направлений: сосудистая хирургия, флебология, косметология, анализы, УЗИ. Высококвалифицированные специалисты. Запись на прием по телефону.',
