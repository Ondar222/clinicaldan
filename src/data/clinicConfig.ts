...
export const CLINIC_CONFIG: ClinicContact & SeoConfig = {
  ...
  defaultTitle: 'Клиника Алдан — многопрофильный медицинский центр в Алдане',
  defaultDescription: 'Клиника Алдан в Алдане с 2013 года. Более 25 медицинских направлений: сосудистая хирургия, флебология, косметология, анализы, УЗИ, чекап. Высококвалифицированные специалисты. Запись на прием по телефону.',
