 ...
 */
export function isExcludedCosmetologyDoctor(doctor) {
...
export const COSMETOLOGY_CATEGORIES = [
    {
        id: 'injection',
        slug: 'injection',
 ...
 */
export function getCosmetologyCategory(serviceName, groupName) {
